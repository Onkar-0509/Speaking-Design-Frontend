...
const ShowExpense = () => {
  ...
  return (
    <div className="container mx-auto p-4 min-h-[80vh]">
      ...
      {/* Total Expense */}
      <div className="mt-6 mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-blue-100">
        <p className="text-xl font-medium text-gray-700 flex items-center justify-between">
          ...
          <span className="text-2xl font-bold text-blue-600 bg-white px-4 py-2 rounded-lg shadow-inner">
